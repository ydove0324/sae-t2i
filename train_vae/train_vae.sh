...
# VAE_CKPT="/cpfs01/huangxu/models/SAE/noise_tau_0.8_from_scratch/0000485000/models/ema_vae.pth"    # Decoder Only
VAE_CKPT="results_vae/cnn_decoder_finetune_vf_loss0p1_lora_rank256_ganloss0p01_frozen_dinov3_gramloss/step_45000.pth"
...
torchrun --nnodes=1 --node_rank=0 \
    ...
    --train-path "/cpfs01/huangxu/ILSVRC/Data/CLS-LOC/train/" \
    --val-path "/cpfs01/huangxu/ILSVRC/Data/CLS-LOC/val/" \
    --vae-ckpt $VAE_CKPT \
    --output-dir "results_vae/cnn_decoder_finetune_vf_loss0p1_lora_rank256_ganloss0p01_frozen_dinov3_gramloss_clamp3" \
    --batch-size 32 \
    --image-size 256 \
    --lr 1e-4 \
    --l1-weight 1.0 \
...
# nohup env CONFIG_FILE="train_vae/configs/dinov3_vitl.yaml" bash train_vae/train_with_config.sh > log/dinov3_vitl.log 2>&1 &
