...
hdfs dfs -get \
    hdfs://haruna/home/byte_data_seed/hdd_hldy/user/ming.li1/work_dirs/vfm_exp/ming_dino_vae_exp/1026_masked_sae-e2e_from_pt_w_noise_0.8_denormalize_kl200/states/0000215000/models \
    /opt/tiger/vfm/weights/dinov3
hdfs dfs -get \
    hdfs://haruna/home/byte_data_seed/hdd_hldy/user/ming.li1/work_dirs/vfm_exp/ming_dino_vae_exp/1026_masked_sae-e2e_from_pt_w_noise_0.8_denormalize_kl200/configs \
    /opt/tiger/vfm/weights/dinov3

python3 -m venv rae
source rae/bin/activate
...
export ENTITY="fobow"
export PROJECT="sae-imagenet-noise-1536-e2e-kl200"
...
hdfs dfs -get hdfs://harunava/home/byte_data_seed_vagcp/user/xiaojieli/sae_1536_batch_1024_vae_noise_e2e_kl200/results/sae/stage2/checkpoints/latest.pt $WORK_DIR/sae/stage2/checkpoints
