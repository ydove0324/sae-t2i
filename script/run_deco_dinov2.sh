...
VAE_CKPT="results_sae/dinov2_base_vit_decoder_hf_dim64_dropout0p4_GAN0p5/step_60000.pth"
...
torchrun --nnodes=$NUM_NODES --node_rank=$NODE_RANK \
  ...
  --config projects/rae/configs/stage2/training/ImageNet256/DiTDH-XL_DECO-DINOv2-B.yaml \
  --data-path /cpfs01/huangxu/ILSVRC/Data/CLS-LOC/train/ \
  --results-dir ./result_dit/result_deco_dinov2_sae_bs512 \
